...
import com.simd.RemoteKeyListener.Stub;

@TargetApi(Build.VERSION_CODES.ICE_CREAM_SANDWICH)
public class CloudKBInputMethod extends InputMethodService {
        ...
        try {
          ...
          keyboardListener = new RemoteKeyListener.Stub() {
            ...
            public boolean setText(String text) throws RemoteException {
              return CloudKBInputMethod.this.setText(text);
            }
            @Override
            public String getText() throws RemoteException {
              return CloudKBInputMethod.this.getText();
            }
          };
          RemoteKeyboard.Stub.asInterface(service).registerKeyListener(keyboardListener);
        } catch (RemoteException e) {
          throw new RuntimeException(
              "CloudKBInputMethod failed to connected to HttpService.", e);
        }
      }
      //@Override
...
//        Debug.d("WiFiInputMethod disconnected from HttpService.");
    ...
    bindService(intent, serviceConnection, Context.BIND_AUTO_CREATE | Context.BIND_ABOVE_CLIENT);
  }
...
//      Debug.d("connection closed");
  ...
  void receivedKey(int code, boolean pressed) {
    if (code == KeyboardHttpPoller.FOCUS) {
