...
public final class KeycodeConvertor {
  public static int convertKey(int code) {
    ...
    switch (code) {
      ...
      case 1024: return 1024; // FOCUS
      case 36: return CloudKBInputMethod.KEY_HOME;
      case 35: return CloudKBInputMethod.KEY_END;
      case 17: return CloudKBInputMethod.KEY_CONTROL;
      case 46: return CloudKBInputMethod.KEY_DEL;
