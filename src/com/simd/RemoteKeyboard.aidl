...
import com.simd.RemoteKeyListener;
import com.simd.SharedKeyUpdateListener;
...
interface RemoteKeyboard {
    ...
    void addSharedKeyUpdateListener(SharedKeyUpdateListener listener);
    void removeSharedKeyUpdateListener(SharedKeyUpdateListener listener);
